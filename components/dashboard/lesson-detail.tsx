    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="grid gap-8 lg:grid-cols-2 items-start">
              ...
              <div className="hidden lg:flex flex-col items-end justify-between gap-4 self-stretch">
                <WallpaperDownloadButton
                  ...
                  focusReframeTechnique={lesson.focus_reframe_technique}
                  quote={lesson.quote || ""}
                  mentalModel={lesson.mental_model || ""}
                  reflectionQuestion={lesson.reflection_question}
                  aiLeadershipLens={lesson.ai_leadership_lens}
      ...
      <div className="grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* 6. Executive Challenge - NEW V2 Section */}
          ...
          {/* 8. Reflection Quote - Emotional Layer */}
          {lesson.quote && (
            <Card className={cn(
          ...
          {/* Score Metric - Milestone Design - Final Section */}
          {lesson.score_metric && (
            <Card className={cn(
              "group overflow-hidden transition-all duration-300 animate-slide-up",
              "shadow-md hover:shadow-lg border-0"
        ...
        <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-20 lg:self-start">
          {/* Mental Model - Thinking Framework */}
          {lesson.mental_model && (
            <Card className={cn(
              "group overflow-hidden transition-all duration-300 animate-slide-up",
              "shadow-md hover:shadow-lg border-0"
